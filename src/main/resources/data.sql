...
INSERT INTO shipment_state(id_shipment_state, friendly_id, description, name)
SELECT 5, 'BRANCH_OUT', 'Dejó el branch', 'Dejó el branch'
WHERE NOT EXISTS(SELECT id_shipment_state FROM shipment_state WHERE id_shipment_state = 5);
