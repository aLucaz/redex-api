...
public class ShipmentGateway {
    ...
    public void persistWithPath(PathDto path, Boolean isSimulated, Integer shipmentStateId){
        Shipment shipment = ShipmentParser.mapToRow(path, shipmentStateId, isSimulated);
